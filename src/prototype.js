export function initializePrototype() {
      ...
      function buildResultEvents() {
        return [
          {
            id: 'r1',
            title: '湘潭大学与江西财经大学并列第 106 名',
            summary: '湘潭大学在 2026 年 ABC 中国大学排名中位列第 106 名，总分 68.53；江西财经大学同分并列第 106 名（带星号）。综合来看，两校在学科结构上差异明显：湘潭大学为综合类高校，法学、数学等学科较强；江西财经大学以财经类见长，其带星号排名表示按财经类高校折算得出。评价体系上，该榜单综合了科研产出、师资规模、生源质量与社会声誉等多维指标，两校总分接近但优势领域不同，考生择校时应结合专业方向、地域偏好与就业去向综合判断，而非只看综合排名的名次高低。',
            source: '小木虫',
            avatar: '木',
            time: '01-23 12:40',
            tags: ['地点-湖南', '指标-68.53', '话题-综合类'],
            reference: '【榜单概况】\n2026 年 ABC 中国大学排名公布后，湘潭大学与江西财经大学均以 68.53 分位于第 106 名。榜单从人才培养、师资队伍、学科建设、科学研究、社会服务和办学资源等方面进行综合评价，用于观察高校的综合发展情况。\n\n【湘潭大学】\n湘潭大学位于湖南省湘潭市，是一所以综合学科布局为基础的高校。学校在数学、法学、材料科学、化学等方向具有较明显的学科积累，近年来持续推进基础研究平台建设和交叉学科协同。本次榜单得分反映了学校在科研产出、师资结构和学科建设等方面的综合表现。\n\n【江西财经大学】\n江西财经大学位于江西省南昌市，以经济学、管理学为优势，同时覆盖法学、工学、文学等学科。学校在财经人才培养、应用经济研究和政产学合作方面具有较强特色。榜单中的星号表示该名次结合财经类高校的分类评价结果进行折算，适合用于同类型高校之间的参考比较。\n\n【分数与名次说明】\n两校总分相同，并不代表各项指标表现完全一致。湘潭大学的优势更集中在综合性学科和基础研究，江西财经大学的优势则更多体现在财经类专业、行业影响力和应用研究。综合名次只能反映多项指标加权后的结果，不能替代专业维度的比较。\n\n【评价指标说明】\n综合得分主要参考科研项目与成果、师资规模与结构、人才培养质量、生源情况、学科平台、社会声誉及服务贡献等指标。不同榜单在指标口径、权重和数据周期上可能存在差异，因此相同学校在不同榜单中的位次可能有所变化。\n\n【参考建议】\n如果用于择校，应继续比较目标专业实力、培养方案、所在城市、升学与就业去向等信息；如果用于学校综合对比，建议同时查看官方学科评估、学校年度报告及多个榜单结果，避免仅依据单一名次作出判断。\n\n数据来源：ABC 排名官微、中国大学排行榜（CNUR）网站公开信息整理。更新时间：2026 年 1 月；最终内容以发布方公示为准。',
